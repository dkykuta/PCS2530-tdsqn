...
@TextureInfo(name = TextureName.WIN)
public class WinTheGameBanner extends GameEntity {

	public WinTheGameBanner(final Scene fScene, final Vector2D pos)
			throws Exception {
		super(fScene, pos);
	}

	public WinTheGameBanner(final Scene fScene, final int x, final int y)
			throws Exception {
